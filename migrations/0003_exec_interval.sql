-- Migration: add exec_interval column to segments and update save_event RPC.
-- Run in the Supabase SQL editor after 0002_update_save_event_rpc.sql.

ALTER TABLE segments ADD COLUMN IF NOT EXISTS exec_interval INTEGER;
